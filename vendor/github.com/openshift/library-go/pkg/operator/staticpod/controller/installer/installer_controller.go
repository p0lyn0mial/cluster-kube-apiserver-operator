...
func prepareNodeStatusApplyConfigurationForUpdatedNode(nodeStatuses []operatorv1.NodeStatus, updatedNodeStatus *operatorv1.NodeStatus) []*applyoperatorv1.NodeStatusApplyConfiguration {
...
func nodeStatusesToNodeStatusApplyConfigurations(nodeStatuses []operatorv1.NodeStatus) []*applyoperatorv1.NodeStatusApplyConfiguration {
	var ret []*applyoperatorv1.NodeStatusApplyConfiguration
...
func prepareAvailableProgressingNodeInstallerFailingConditionsApplyConfigurations(nodeStatuses []*applyoperatorv1.NodeStatusApplyConfiguration, latestAvailableRevision int32) []*applyoperatorv1.OperatorConditionApplyConfiguration {
...
func (c InstallerController) Sync(ctx context.Context, syncCtx factory.SyncContext) error {
	...
	nodeStatusApplyConfigurations := prepareNodeStatusApplyConfigurationForUpdatedNode(originalOperatorStatus.NodeStatuses, updatedNode)
	operatorConditionApplyConfigurations := prepareAvailableProgressingNodeInstallerFailingConditionsApplyConfigurations(nodeStatusApplyConfigurations, originalOperatorStatus.LatestAvailableRevision)
